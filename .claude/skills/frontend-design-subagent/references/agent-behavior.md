# Frontend Design Subagent — Agent Behavior Specification
...
**Command:**
```bash
node .claude/skills/frontend-design-subagent/scripts/validate-concepts-playwright.mjs --pass-dir <outputDir>
```
